...
func GetCameraRTSPURL(device Device, i int) string {
	return "rtsp://" + device.Username + ":" + device.Password + "@" + device.Address + ":" + fmt.Sprint(device.Port) + "/" + device.RtspStreams[i].Stream
}
